...
int ordenar_crescente(int *cod, char nomes[][TAM_NOME], float * media, char resultado[][TAM_RES]){
...
int main(){
    ...
    eficiencia = ordenar_crescente(cod, nomes, media, resultado);

    printf("Foi necessario %d interacoes\n", eficiencia);
    for(i = QT_ALUNOS-131; i < QT_ALUNOS; i++){
